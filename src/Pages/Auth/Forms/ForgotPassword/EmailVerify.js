...
class EmailVerify extends Component {
  ...
  render() {
    ...
    let LoginSumbitButton = (
      <SumbitButton className={"sitebtnInv"} Label={"Submit"} />
    );

    if (this.state.loading) {
      LoginSumbitButton = <SpinnerButton spinnerclass={"sitebtnInv"} />;
    }

    let form = <div className=""></div>;

    return (
      <div>
        {alertContent}
        <div className="d-flex flex-column min100vh justify-content-center align-items-center">
          <MainPage
            shelp={false}
          ...
          />
          <form
            className="w-100 align-items-center d-flex flex-column"
