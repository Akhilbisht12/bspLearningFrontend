...
class ForgotPasswordotp extends Component {
  ...
  render() {
    ...
    let SigninSumbitButton = (
      <SumbitButton className={"sitebtnInv"} Label={"Confirm OTP"} />
    );

    if (this.state.loading) {
      SigninSumbitButton = <SpinnerButton spinnerclass={"sitebtnInv"} />;
    }

    let form = (
      <div>
        <form
          className="w-100 d-flex align-items-center flex-column justify-content-center min100vh"
